...
;
Function : Type _IDENT_ _SYMB_0 ListDecl _SYMB_1 _SYMB_2 ListStm _SYMB_3 { $$ = make_Fun($1, $2, $4, reverseListStm($7)); YY_RESULT_Function_= $$; } 
;
...
;
Exp : _IDENT_ _SYMB_7 Exp { $$ = make_EAss($1, $3); YY_RESULT_Exp_= $$; } 
...
;
Exp4 : _IDENT_ _SYMB_0 ListExp _SYMB_1 { $$ = make_Call($1, $3); YY_RESULT_Exp_= $$; } 
